import{s as ot,i as rt}from"./i18n-AWaX6YDT.js";const r={sources:[],layers:[],activeLayer:null,tool:"move",brushSize:16,tolerance:32,canvasW:512,canvasH:512,zoom:1,showGrid:!0,gridSize:128,snap:!1,status:"Abra uma ou mais imagens e extraia pedaços para compor.",extract:null,layerCounter:0};let xe,S,H=null,U=null,me=!1,C=null,Fe=!1;const pe=new Map,$e=[],ct=15;function fe(e){const a=document.createElement("canvas");return a.width=e.width,a.height=e.height,a.getContext("2d").drawImage(e,0,0),a}function N(){$e.push({layers:r.layers.map(e=>({...e,canvas:fe(e.canvas)})),activeLayer:r.activeLayer}),$e.length>ct&&$e.shift()}function Ke(){const e=$e.pop();if(!e){r.status="Nada para desfazer.",F();return}r.layers=e.layers,r.activeLayer=e.activeLayer,r.status="Desfeito.",F()}function re(e){return e.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[a])}function Q(e,a,i){return Math.max(a,Math.min(i,e))}function G(){return r.layers.find(e=>e.id===r.activeLayer)??null}function Ye(e){return r.layerCounter+=1,`${e}_${r.layerCounter}`}function ve(e,a,i){let n=(a-e.x)/e.scale;const s=(i-e.y)/e.scale;return e.flipX&&(n=e.canvas.width-n),{x:n,y:s}}function lt(e,a,i){const n=ve(e,a,i),s=Math.floor(n.x),o=Math.floor(n.y);return s<0||o<0||s>=e.canvas.width||o>=e.canvas.height?0:e.canvas.getContext("2d",{willReadFrequently:!0}).getImageData(s,o,1,1).data[3]}function Re(e,a){for(let i=r.layers.length-1;i>=0;i-=1){const n=r.layers[i];if(n.visible&&lt(n,e,a)>8)return n}return null}function Ze(e){const i=e.getContext("2d",{willReadFrequently:!0}).getImageData(0,0,e.width,e.height).data;let n=e.width,s=e.height,o=-1,c=-1;for(let u=0;u<e.height;u+=1)for(let p=0;p<e.width;p+=1)i[(u*e.width+p)*4+3]>8&&(p<n&&(n=p),u<s&&(s=u),p>o&&(o=p),u>c&&(c=u));if(o<n)return e;const l=document.createElement("canvas");return l.width=o-n+1,l.height=c-s+1,l.getContext("2d").drawImage(e,-n,-s),l}function dt(e,a){xe=a,S=e,F()}function F(){S.innerHTML=`
